...
public class Result {
    ...
    public Result(Integer code) {
        ...
        switch (code) {
            ...
            case -20201 -> this.message = "User's unique information has been registered";
            case -20202 -> this.message = "The club already exists";
            case -20203 -> this.message = "User does not exist";
            case -20204 -> this.message = "Password error";
            case -20205 -> this.message = "Phone not registered";
            case -20206 -> this.message = "Email not registered";
            ...
            case -20210 -> this.message = "The user has been locked out due to too many wrong passwords";
            ...
            case -20304 -> this.message = "Application form has been deleted";
            case -20305 -> this.message = "Application form does not exist";
            case -20306 -> this.message = "Error in status setting";
            case -20307 -> this.message = "Application form has been approved";
            case -20308 -> this.message = "The status of the application form is abnormal";
